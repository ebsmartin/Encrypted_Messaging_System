...
public class SubstitutionCipher {
    ...
    public static String encrypt(String str, String mapTo, String mapFrom) {
        ...
        for(int i = 0; i < str.length(); i++) {
        	...
        	String charStr = String.valueOf(strChar);
        	if(!mapFrom.contains(charStr) == true) {  // returns characters that are not in the map as same character
            		rtn.append(charStr);	
        		}
        	else {
        		int fromCharIndex = mapFrom.indexOf(charStr);
        		char toCharIndex = mapTo.charAt(fromCharIndex);
        		rtn.append(String.valueOf(toCharIndex));
        	 }
        	}
        //END TODO
        return rtn.toString();
